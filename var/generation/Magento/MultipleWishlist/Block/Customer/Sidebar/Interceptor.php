...
class Interceptor extends \Magento\MultipleWishlist\Block\Customer\Sidebar implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Framework\App\Http\Context $httpContext, \Magento\MultipleWishlist\Helper\Data $multipleWishlistHelper, array $data = array())
    {
        $this->___init();
     ...
     * {@inheritdoc}
     */
    public function getItemPriceHtml(\Magento\Catalog\Model\Product\Configuration\Item\ItemInterface $item, $priceType = 'configured_price', $renderZone = 'item_list', array $arguments = array())
    {
